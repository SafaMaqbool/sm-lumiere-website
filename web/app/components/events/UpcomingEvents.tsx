          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {events.map((event, i) => (
              <Reveal key={event._id} delay={(i % 3) * 80}>
                <div className="group bg-cream rounded-lg overflow-hidden shadow-sm border-t-4 border-gold flex flex-col transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
                  {event.coverImage && (
