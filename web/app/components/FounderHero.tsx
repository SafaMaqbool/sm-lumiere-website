    ...
    <section className="bg-black py-14 sm:py-20 md:py-28">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <h1 className="font-heading text-2xl sm:text-3xl md:text-5xl font-semibold text-white mt-4 leading-tight">
            Meet Shagufta Munaf
          </h1>
          <p className="font-body text-sm md:text-base tracking-[0.15em] uppercase text-gold mt-3">
            Founder &amp; CEO, SM Lumière
          </p>
          <p className="font-body text-base md:text-lg text-white/70 leading-relaxed mt-6">
          ...
          <p className="font-body text-base md:text-lg text-white/70 leading-relaxed mt-4">
